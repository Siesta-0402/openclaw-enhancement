...
import { emitSessionStartSignal, emitSessionEndSignal } from '../autonomous/instinct/instinct-system.js';
...
export function emitSessionStarted(
  ...
  // Signal instinct system about session start
  emitSessionStartSignal(sessionKey, metadata);
}
...
export function emitSessionEnded(
  ...
  // Signal instinct system about session end
  emitSessionEndSignal(sessionKey, metadata);
}
